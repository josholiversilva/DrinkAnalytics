...
const ChangeDate = () => {
    ...
    return (
        <>
            <div className="text-[#95c4fe] text-4xl w-full text-center font-bold outline-4 outline-gray-300 flex space-x-3">
            ...
            <div className="flex h-8 w-full justify-center items-center mt-3">
                <div className="flex space-x-2 h-8 w-1/6 items-center justify-center text-[#95c4fe]">
                { time === 'y' ?
